...
// import image2 from "../../assets/images/cover5.png";
// import image from "../../assets/images/earth-hd-desktop-background-wallpaper-preview.jpg";
...
export default function Landing() {
  return (
    <div className={styles.body}>
      ...
      <div className={styles.parpadeo}>{/* <img src={image2} alt="" /> */}</div>
